...
export default function Contact() {
    return (
        <>
            <Helmet>
                <title>Contact — Pavan Kalyan & Associates | Chartered Accountants</title>
                <meta
                    name="description"
                    content="Contact Pavan Kalyan & Associates for GST filing, income tax services, audits, accounting and business compliance support in Bengaluru."
                />
            </Helmet>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-10">
                    ...
                    >
                        ...
                        >
                            ...
                            <a href="tel:+919590150805" className="text-[15px] hover:underline">
                                +91 95901 50805
                            </a>
                        </motion.div>
